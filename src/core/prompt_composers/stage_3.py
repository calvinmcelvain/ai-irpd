"""
Contains the Stage3PromptComposer model.
"""
import logging
...
class Stage3PromptComposer(BaseComposer):
    """
    Stage3PromptComposer model.
    
    Composes the prompts for stage 3.
    """
    ...
    def _construct_user_prompt(self, test_output: TestOutput) -> str:
        # Individual summaries for stage 3.
